...
/**
 * the class for CoinSorterMachine
...
public class CoinSorterMachine {
    ...
    /**
     * this initalizes the coins array list
     */
    ...
    /**
     * this uses a scanner to read the user input and the also the file the user givens
     * store the data in an array list
     */
    ...
    /**
     * caculaotes the total amount of money
     * @return returns the final amount of all the money added up
     */
